              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Create, test, and deploy AI agents that automate tasks
                    within ERP systems. Streamline your business processes with
                ...
                <div className="relative h-[350px] w-[350px] sm:h-[400px] sm:w-[400px] md:h-[450px] md:w-[450px] lg:h-[500px] lg:w-[500px]">
                  ...
                  <div className="relative h-full w-full bg-muted rounded-lg overflow-hidden flex items-center justify-center">
                    <div className="text-center p-6">
                      <div className="text-4xl font-bold mb-4">AI Agent</div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Everything you need to build powerful AI agents for your ERP
                  systems
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-muted-foreground">
                  Visually design agent workflows with drag-and-drop components
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground">
                ...
                <p className="text-center text-muted-foreground">
                  Customize agent behavior and logic with syntax highlighting
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground">
                ...
                <h3 className="text-xl font-bold">Simulation Panel</h3>
                <p className="text-center text-muted-foreground">
                  Test agents against mock ERP data before deployment
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground">
                ...
                <p className="text-center text-muted-foreground">
                  Pre-built agent templates for common ERP tasks
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground">
                ...
                <p className="text-center text-muted-foreground">
                  Monitor agent efficiency and success rates with detailed
                  dashboards
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-muted-foreground">
                  Deploy agents to your ERP system with a single click
                </p>
              </div>
            </div>
          </div>
